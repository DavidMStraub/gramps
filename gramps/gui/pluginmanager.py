...
class GuiPluginManager(Callback):
    ...
    def get_reg_reports(self, gui=True):
        ...
        return [
            plg
            for plg in self.basemgr.get_reg_reports(gui)
    ...
    def get_reg_tools(self, gui=True):
        ...
        return [
            plg
            for plg in self.basemgr.get_reg_tools(gui)
            if plg.id not in self.__hidden_plugins
        ]
    ...
    def get_reg_views(self):
        ...
        return [
            plg
            for plg in self.basemgr.get_reg_views()
            if plg.id not in self.__hidden_plugins
        ]
    ...
    def get_reg_quick_reports(self):
        ...
        return [
            plg
            for plg in self.basemgr.get_reg_quick_reports()
            if plg.id not in self.__hidden_plugins
        ]
    ...
    def get_reg_mapservices(self):
        ...
        return [
            plg
            for plg in self.basemgr.get_reg_mapservices()
            if plg.id not in self.__hidden_plugins
        ]
    ...
    def get_reg_bookitems(self):
        ...
        return [
            plg
            for plg in self.basemgr.get_reg_bookitems()
            if plg.id not in self.__hidden_plugins
        ]
    ...
    def get_reg_gramplets(self):
        ...
        return [
            plg
            for plg in self.basemgr.get_reg_gramplets()
            if plg.id not in self.__hidden_plugins
        ]
    ...
    def get_reg_importers(self):
        ...
        return [
            plg
            for plg in self.basemgr.get_reg_importers()
            if plg.id not in self.__hidden_plugins
        ]
    ...
    def get_reg_exporters(self):
        ...
        return [
            plg
            for plg in self.basemgr.get_reg_exporters()
            if plg.id not in self.__hidden_plugins
        ]
    ...
    def get_reg_docgens(self):
        ...
        return [
            plg
            for plg in self.basemgr.get_reg_docgens()
            if plg.id not in self.__hidden_plugins
        ]
    ...
    def get_reg_databases(self):
        ...
        return [
            plg
            for plg in self.basemgr.get_reg_databases()
            if plg.id not in self.__hidden_plugins
        ]
    ...
    def get_reg_general(self, category=None):
        return [
            plg
            for plg in self.basemgr.get_reg_general(category)
            if plg.id not in self.__hidden_plugins
        ]
